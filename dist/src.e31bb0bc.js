...
function (_Component) {
  ...
  _createClass(Tracks, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, tracks.map(function (track, index) {
        var name = track.name,
            album = track.album,
...
function (_Component) {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function () {
      ...
      fetch("".concat(API_ADDRESS, "/artist/").concat(_this.state.artistQuery)).then(function (response) {
        ...
        if (responseData.artists.total > 0) {
          var artist = responseData.artists.items[0];
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      }, "Search"), _react.default.createElement("hr", null), _react.default.createElement(_Artist.default, {
